...
// import resume from "../ProfilePic/Rajat.pdf"
function ProfilePic() {
  return (
    <>
      <div className="flex pt-16 pb-3 gap-4 w-full px-14">
        ...
        <div className="ms-20 w-3/4 backdrop-opacity-10 border-2 border-solid rounded-xl bg-white/30">
          <div className="w-fit h-full p-5 font-bold"><h1 className="p-5 text-5xl cursor-default">Hi, I'm <span className="text-cyan-300">Rajat Jamgade</span></h1>
            ...
            <div className="w-fit h-fit gap-2 flex p-5 ">
              ...
              <a className="transition ease-in-out hover:-translate-y-5 hover:scale-150 hover:text-cyan-400 border-2 border-black rounded-full duration-300 p-2" title="Gmail">
                <FaGoogle className="w-5 h-fit" /></a>
              <a className="transition ease-in-out hover:-translate-y-5 hover:scale-150 hover:text-cyan-400 border-2 border-black rounded-full duration-300 p-2" title="Outlock">
                <PiMicrosoftOutlookLogoFill className="w-5 h-fit" /></a>
            </div>
            <button id="download" href='React Rajat.pdf' download="Rajat.pdf" className="bg-gradient-to-r from-cyan-500 to-black hover:bg-gradient-to-l hover:cursor-pointer shadow-inner shadow-black rounded-xl text-cyan-100 text-xl flex p-2 gap-2 ml-5"><FaDownload className="w-6 h-fit mt-1" />Download CV</button>
          </div>
        </div>
      </div>
    </>
